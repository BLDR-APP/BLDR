...
void setupInjection() {
  ...
  getIt.registerFactory(() => GetMealsForDate(getIt<NutritionDiaryRepository>()));
  getIt.registerFactory(() => GetDailySummary(getIt<NutritionDiaryRepository>()));
  getIt.registerFactory(() => DeleteMealEntry(getIt<NutritionDiaryRepository>()));
  getIt.registerFactory(() => UpdateMealQuantity(getIt<NutritionDiaryRepository>()));
  getIt.registerFactory(() =>
      LogMeal(getIt<NutritionDiaryRepository>(), getIt<NutritionXpRepository>()));
  ...
  getIt.registerFactory(() => GetNutritionGoals(getIt<NutritionGoalsRepository>()));
  ...
  getIt.registerFactory(() => GetWorkoutTemplates(getIt<WorkoutTemplateRepository>()));
  getIt.registerFactory(() => GetTemplateWithExercises(getIt<WorkoutTemplateRepository>()));
  getIt.registerFactory(() => CreateWorkoutTemplate(getIt<WorkoutTemplateRepository>()));
  getIt.registerFactory(() => UpdateWorkoutTemplate(getIt<WorkoutTemplateRepository>()));
  ...
  getIt.registerFactory(() => HasActiveWorkout(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => GetActiveWorkoutDetails(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => WatchActiveWorkout(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => GetWorkoutDetails(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => GetWorkoutHistory(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => GetPausedWorkouts(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => EnsureWorkoutSets(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => DeletePausedWorkout(getIt<WorkoutSessionRepository>()));
  getIt.registerFactory(() => DeleteCompletedWorkout(getIt<WorkoutSessionRepository>()));
  ...
  getIt.registerFactory(() => GetWeeklyPlanConfig(getIt<WeeklyPlanRepository>()));
  getIt.registerFactory(() => SaveWeeklyPlanConfig(getIt<WeeklyPlanRepository>()));
  ...
  getIt.registerFactory(() => GetWeekCompletedWorkouts(getIt<WeeklyPlanRepository>()));
  getIt.registerFactory(() => GetWorkoutMuscles(getIt<WeeklyPlanRepository>()));
  getIt.registerFactory(() => DeleteCompletedClubWorkout(getIt<WeeklyPlanRepository>()));
  ...
  getIt.registerFactory(() => LogExtraActivity(getIt<ExtraActivityRepository>()));
  getIt.registerFactory(() => GetExtraActivities(getIt<ExtraActivityRepository>()));
  ...
  getIt.registerFactory(() => GetOnboardingContext(getIt<OnboardingRepository>()));
  ...
  getIt.registerFactory(() => GetMeasurementProgress(getIt<ProgressRepository>()));
  ...
  getIt.registerFactory(() => GetAchievementCatalog(getIt<AchievementsRepository>()));
  getIt.registerFactory(() => GetUserAchievements(getIt<AchievementsRepository>()));
  getIt.registerFactory(() => CheckAndUnlockAchievements(getIt<AchievementsRepository>()));
  getIt.registerFactory(() => GetWorkoutAchievementContext(getIt<AchievementsRepository>()));
  ...
  getIt.registerFactory(() => GetMyClubTemplates(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => CreateClubTemplate(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => UpdateClubTemplate(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => StartClubWorkout(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => CompleteClubWorkout(getIt<ClubWorkoutRepository>()));
  ...
  getIt.registerFactory(() => WatchActiveClubWorkout(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubWorkoutHistory(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => LogClubCardio(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => IsUserInActiveChallenge(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubPublicTemplates(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubTemplateExercises(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubWorkoutsBetween(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubActivitiesBetween(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubXpBetween(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubWorkoutDetails(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetClubTemplateWithExercises(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => DeleteClubTemplate(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetPausedClubWorkouts(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => DeletePausedClubWorkout(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => DeleteClubWorkoutRecord(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => EnsureClubWorkoutSets(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => DeleteClubActivityRecord(getIt<ClubWorkoutRepository>()));
  ...
  getIt.registerFactory(() => RemoveReactionFromXpEvent(getIt<ChallengeRepository>()));
  ...
  getIt.registerFactory(() => GetCollectiveChallenges(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => JoinCollectiveChallenge(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => LeaveCollectiveChallenge(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => CreateCollectiveChallenge(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetChallengeDetail(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetMyChallengeParticipation(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetChallengeTopContributors(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetChallengeFeed(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetChallengeMilestones(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetChallengeComments(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => AddChallengeComment(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => ReportChallenge(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => UpdateChallengeSettings(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetPendingDuelInvite(getIt<ChallengeRepository>()));
  ...
  getIt.registerFactory(() => GetClubNotifications(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => MarkAllNotificationsRead(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => MarkNotificationRead(getIt<ChallengeRepository>()));
  getIt.registerFactory(() => GetPublicClubProfile(getIt<ChallengeRepository>()));
  ...
  getIt.registerFactory(() => GetCurrentOperation(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => GetOperationProgress(getIt<ClubWorkoutRepository>()));
  getIt.registerFactory(() => TryIncrementOperation(getIt<ClubWorkoutRepository>()));
  ...
  getIt.registerFactory(() => GetClubAnnouncements(getIt<ClubCommunityRepository>()));
  ...
  getIt.registerFactory(() => GetSubscriptionPlans(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => GetCurrentSubscription(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => CreateStripeSubscription(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => ProcessStripePayment(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => ProcessApplePurchase(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => CancelSubscription(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => WatchPurchaseSuccess(getIt<SubscriptionRepository>()));
  getIt.registerFactory(() => WatchPurchaseError(getIt<SubscriptionRepository>()));
  ...
  getIt.registerLazySingleton<ExerciseDbRapidService>(
      () => ExerciseDbRapidService.instance);
  getIt.registerLazySingleton<NutritionService>(() => NutritionService.instance);
  getIt.registerLazySingleton<FatSecretService>(() => FatSecretService.instance);
  ...
  getIt.registerLazySingleton<ClubWorkoutsService>(
      () => ClubWorkoutsService.instance);
  getIt.registerLazySingleton<CommunityService>(() => CommunityService.instance);
