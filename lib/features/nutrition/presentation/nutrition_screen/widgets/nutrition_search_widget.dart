...
import 'package:bldr_fitness/services/nutrition_service.dart'; // Assume-se que esta classe usa o Supabase.
import 'package:bldr_fitness/features/nutrition/presentation/nutrition_screen/widgets/barcode_scanner_page.dart';
      ...
      builder: (context, scrollController) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context).nutrition_search_food_title,
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppLocalizations.of(context).nutrition_search_hint,
            ...
            if (_searchQuery.isEmpty)
              Text(
                AppLocalizations.of(context).nutrition_popular_foods,
            ...
            if (_searchQuery.isNotEmpty)
              Text(
                AppLocalizations.of(context).nutrition_search_results_count(_searchResults.length),
                style: AppTheme.darkTheme.textTheme.titleMedium?.copyWith(
                  color: AppTheme.textPrimary,
                  fontWeight: FontWeight.w600,
                ),
