  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppTheme.primaryBlack,
        title: Text(
          AppLocalizations.of(context).nutrition_scan_title,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2.h),
                  Text(
                    AppLocalizations.of(context).nutrition_scan_hint,
                  ...
                  SizedBox(height: 1.h),
                  Text(
                    AppLocalizations.of(context).nutrition_scan_auto,
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                _buildControlButton(
                  'flash_on',
                  AppLocalizations.of(context).nutrition_scan_flash,
                  () => cameraController.toggleTorch(),
                ),
                _buildControlButton(
                  'flip_camera_ios',
                  AppLocalizations.of(context).nutrition_scan_camera_label,
