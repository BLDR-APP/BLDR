...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _showPlanUpgradeDialog() async {
    try {
          ...
          builder: (context, scrollController) => Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 1.h),
                Text(
                  AppLocalizations.of(context)!.profile_plan_choose_subtitle,
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                if (plan.isPopular)
                                  Container(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context)!.profile_plan_popular_badge,
                                      style: AppTheme
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 2.w),
                                Text(
                                  AppLocalizations.of(context)!.profile_plan_annual_prefix(plan.annualPriceText),
                                  style: AppTheme
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(
                                  isCurrentPlan
                                      ? AppLocalizations.of(context)!.profile_plan_current
                                      : AppLocalizations.of(context)!.profile_plan_choose_btn,
                                  style: AppTheme
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.profile_plan_load_error('$e')),
          backgroundColor: AppTheme.errorRed,
        ),
      );
    }
