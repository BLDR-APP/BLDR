              ...
              children: [
                  ...
                  children: [
                    ...
                    if (plan.isPopular)
                      Container(
                        ...
                        child: Text(
                          AppLocalizations.of(context).checkout_plan_popular_badge,
                  ...
                  children: [
                    ...
                    if (isAnnual && annualSavings > 0) ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          AppLocalizations.of(context).checkout_savings_amount('R\$${annualSavings.toStringAsFixed(2)}'),
                          style: Theme.of(context).textTheme.labelSmall?.copyWith(
                ...
                if (!isAnnual)
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context).checkout_trial_badge,
