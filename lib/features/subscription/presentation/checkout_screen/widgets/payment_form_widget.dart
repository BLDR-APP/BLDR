...
class PaymentFormWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          AppLocalizations.of(context).checkout_card_info_title,
        ...
        Container(
          ...
          child: stripe.CardField(
            ...
            decoration: InputDecoration(
              labelText: AppLocalizations.of(context).checkout_card_data_label,
              labelStyle: TextStyle(color: AppTheme.textSecondary),
              border: InputBorder.none,
              helperText: AppLocalizations.of(context).checkout_card_helper,
          ...
          child: ElevatedButton(
            ...
            child: isProcessing
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context).checkout_processing,
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
                    color: AppTheme.textVariant,
                    fontWeight: FontWeight.bold,
                  ),
              ...
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  AppLocalizations.of(context).checkout_finalize_btn,
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
                    color: AppTheme.textVariant,
                    fontWeight: FontWeight.bold,
                  ),
