...
class _TodayMetricsWidgetState extends State<TodayMetricsWidget> {
  ...
  /// Streak — histórico consolidado (pessoal + clube); antes usava só
  /// `GetWorkoutHistory` e subcontava usuários que treinam pelo Club.
  Future<void> _loadStreak() async {
    try {
      ...
      final workedDays = (workoutsResult.valueOrNull ?? [])
          .map((w) {
