...
| Watch — `WATCHOS_DEPLOYMENT_TARGET = 26.0`, HKWorkoutSession + HKLiveWorkoutBuilder restaurados (wake lock + FC em tempo real) | ✅ |
| Watch — `WCSessionDelegate @preconcurrency` (Swift 6 + MainActor isolation) | ✅ |
